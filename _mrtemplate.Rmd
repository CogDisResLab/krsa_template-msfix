...
figure_folder <- params[["figure_output"]]

if (!is.null(figure_folder)) {
  ifelse(!dir.exists(figure_folder), dir.create(figure_folder))
  krsa_cv_plot(data_modeled[["normalized"]], clean_peptides) |> ggsave(filename=paste(figure_folder, "cv_plot.svg", sep="/"))
  } else {
...
if (!is.null(figure_folder)) {
  krsa_violin_plot(data_modeled[["scaled"]], clean_peptides, "Group") |> ggsave(filename=paste(figure_folder, "violin_plot_bygroup.svg", sep="/"))
  } else {
...
if (!is.null(figure_folder)) {
  krsa_violin_plot(data_modeled[["scaled"]], clean_peptides, "Barcode") |> ggsave(filename=paste(figure_folder, "violin_plot_bybarcode.svg", sep="/"))
  } else {
...
if (!is.null(figure_folder)) {
  graphics.off()
  pdf(filename=paste(figure_folder, "normalized_heatmap.pdf", sep="/"))
  grid::grid.newpage()
...
if (!is.null(figure_folder)) {
  graphics.off()
  pdf(filename=paste(figure_folder, "normalized_grouped_heatmap.pdf", sep="/"))
  grid::grid.newpage()
